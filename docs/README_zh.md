...
> 源文件格式/输入数据要求与说明：[ZH](README_getdata_ZH.md) | [EN](README_getdata_en.md)    
> save2docx说明文档：[ZH](README_save2docx.md) | [EN](README_save2docx_en.md)     
> 参数说明与用法:[ZH](README_config_zh.md) | [EN](README_config.md)     
> 模拟数据生成说明[ZH](README_simulate_ZH.md) | [EN](README_simulate_EN.md)   
...
> [!Tip]
> 具体参数说明与用法详见[ZH](README_config_zh.md)|[EN](README_config.md)
...
> [!Note]
> save2docx用法具体见[ZH](README_save2docx.md)|[EN](README_save2docx_en.md)
...
1. 设置模拟数据输出路径(本例为"S:\\example\\data")   
  ...
  ```
> [!Tip]
> 具体说明详见[ZH](README_simulate_ZH.md)|[EN](README_simulate_EN.md)
...
> [!Tip]
> 参数具体说明详见[ZH](README_config_zh.md)|[EN](README_config.md)
...
> [!note]   
> 示例生成文档:[文档](../example/result/Result-Report.pdf)  
